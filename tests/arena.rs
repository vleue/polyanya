...
fn arena_mesh() -> Mesh {
    Mesh {
        vertices: vec![
            Vertex::new(2, 2, vec![-1, 4]),
            Vertex::new(1, 3, vec![15, -1]),
            Vertex::new(2, 3, vec![1, 15, -1, 4, 0, 14]),
            Vertex::new(3, 2, vec![2, 0, 4, -1, 5]),
            Vertex::new(3, 1, vec![5, -1]),
            Vertex::new(15, 1, vec![-1, 2, 5]),
            Vertex::new(15, 3, vec![6, 3, 14, 0, 2, -1]),
            Vertex::new(18, 3, vec![95, 37, 6, -1, 12, 7, 92]),
            Vertex::new(18, 2, vec![-1, 12]),
            Vertex::new(19, 1, vec![9, -1]),
            Vertex::new(20, 1, vec![-1, 10, 9]),
            Vertex::new(20, 2, vec![11, 101, 92, 7, 10, -1]),
            Vertex::new(19, 2, vec![10, 7, 12, -1, 9]),
            Vertex::new(23, 2, vec![11, -1, 62, 20, 100]),
            Vertex::new(23, 1, vec![62, -1]),
            Vertex::new(23, 8, vec![95, 92, 101, 104, -1]),
            Vertex::new(24, 7, vec![108, -1, 104, 101, 11, 100]),
            Vertex::new(24, 8, vec![-1, 104]),
            Vertex::new(23, 10, vec![105, 106, 37, 95, -1]),
            Vertex::new(15, 15, vec![37, 106, -1, 99, 91, 3, 6]),
            Vertex::new(18, 18, vec![-1, 94]),
            Vertex::new(19, 15, vec![105, 107, 42, -1, 106]),
            Vertex::new(19, 18, vec![93, 94, -1, 42, 13]),
            Vertex::new(18, 19, vec![117, 115, 8, -1, 94, 93]),
            Vertex::new(15, 19, vec![17, 24, 98, 99, -1, 8]),
            Vertex::new(3, 15, vec![3, 91, -1, 1, 14]),
            Vertex::new(1, 15, vec![-1, 15, 1]),
            Vertex::new(3, 18, vec![99, 98, 16, -1, 91]),
            Vertex::new(2, 18, vec![16, -1]),
            Vertex::new(2, 23, vec![24, 40, 39, -1, 16, 98]),
            Vertex::new(1, 23, vec![39, 38, -1]),
            Vertex::new(3, 48, vec![-1, 18]),
            Vertex::new(15, 48, vec![18, 27, -1]),
            Vertex::new(19, 48, vec![-1, 21]),
            Vertex::new(20, 48, vec![-1, 21, 19]),
            Vertex::new(24, 48, vec![52, -1]),
            Vertex::new(24, 47, vec![36, 52, -1, 22, 50]),
            Vertex::new(23, 46, vec![82, 50, 22, -1, 75, 114]),
            Vertex::new(23, 47, vec![-1, 22]),
            Vertex::new(19, 47, vec![19, 21, -1, 23]),
            Vertex::new(20, 46, vec![47, 75, -1, 19, 23, 111]),
            Vertex::new(15, 47, vec![112, 111, 23, -1, 27]),
            Vertex::new(3, 47, vec![30, 112, 27, 18, -1, 26, 25]),
            Vertex::new(1, 47, vec![28, 26, -1]),
            Vertex::new(1, 35, vec![-1, 28]),
            Vertex::new(2, 35, vec![25, 26, 28, -1, 29]),
            Vertex::new(2, 34, vec![-1, 29]),
            Vertex::new(3, 34, vec![30, 25, 29, -1, 110, 31]),
            Vertex::new(1, 31, vec![32, 33, -1]),
            Vertex::new(3, 31, vec![34, 110, -1, 33]),
            Vertex::new(3, 30, vec![97, 34, 33, 32, -1]),
            Vertex::new(1, 30, vec![-1, 32]),
            Vertex::new(3, 27, vec![17, 97, -1, 41, 40, 24]),
            Vertex::new(2, 27, vec![-1, 41]),
            Vertex::new(1, 26, vec![-1, 38]),
            Vertex::new(2, 26, vec![-1, 38, 39, 40, 41]),
            Vertex::new(15, 31, vec![115, -1, 31, 110, 34, 97, 17, 8]),
            Vertex::new(15, 35, vec![-1, 47, 111, 112, 30, 31]),
            Vertex::new(18, 35, vec![114, 75, 47, -1, 113]),
            Vertex::new(18, 34, vec![113, -1]),
            Vertex::new(19, 31, vec![116, -1, 115, 117, 96]),
            Vertex::new(19, 34, vec![82, 114, 113, -1, 116, 118, 119]),
            Vertex::new(31, 31, vec![118, 116, 96, 51, 85, -1]),
            Vertex::new(31, 35, vec![119, 118, -1, 45, 84]),
            Vertex::new(34, 34, vec![-1, 35]),
            Vertex::new(34, 35, vec![35, 88, 60, 86, 83, 45, -1]),
            Vertex::new(35, 34, vec![-1, 90, 87, 88, 35]),
            Vertex::new(35, 31, vec![-1, 85, 89, 74, 90]),
            Vertex::new(47, 31, vec![74, 59, -1, 87, 90]),
            Vertex::new(47, 35, vec![88, 87, -1, 54, 43, 60]),
            Vertex::new(47, 47, vec![54, 56, -1, 44, 43]),
            Vertex::new(35, 47, vec![86, 60, 43, 44, 55, -1]),
            Vertex::new(31, 47, vec![83, 86, -1, 48, 46]),
            Vertex::new(29, 46, vec![45, 83, 46, 49, -1, 84]),
            Vertex::new(29, 47, vec![-1, 49]),
            Vertex::new(30, 47, vec![48, 53, -1, 49, 46]),
            Vertex::new(26, 46, vec![82, 119, 84, -1, 36, 50]),
            Vertex::new(26, 48, vec![-1, 52, 36]),
            Vertex::new(30, 48, vec![53, -1]),
            Vertex::new(31, 48, vec![-1, 53, 48]),
            Vertex::new(35, 48, vec![55, -1]),
            Vertex::new(47, 48, vec![-1, 55, 44]),
            Vertex::new(48, 47, vec![56, -1]),
            Vertex::new(48, 35, vec![-1, 56, 54]),
            Vertex::new(48, 31, vec![59, 58, -1]),
            Vertex::new(48, 3, vec![-1, 72]),
            Vertex::new(48, 15, vec![57, 72, -1]),
            Vertex::new(48, 19, vec![-1, 58]),
            Vertex::new(47, 19, vec![74, 89, 79, 78, -1, 58, 59]),
            Vertex::new(47, 15, vec![73, 57, -1, 78, 81]),
            Vertex::new(34, 19, vec![89, 85, 51, -1, 65, 79]),
            Vertex::new(31, 19, vec![96, 117, 93, 13, -1, 51]),
            Vertex::new(31, 15, vec![76, 77, 66, -1, 13, 42, 107]),
            Vertex::new(34, 18, vec![-1, 65]),
            Vertex::new(35, 18, vec![-1, 81, 78, 79, 65]),
            Vertex::new(35, 15, vec![-1, 66, 80, 73, 81]),
            Vertex::new(26, 10, vec![103, 76, 107, 105, -1]),
            Vertex::new(26, 7, vec![103, -1, 108, 102, 109]),
            Vertex::new(26, 3, vec![102, 108, 100, 20, -1]),
            Vertex::new(26, 1, vec![-1, 20, 62]),
            Vertex::new(29, 3, vec![109, 102, -1, 63, 67]),
            Vertex::new(30, 2, vec![61, 67, 63, -1, 64]),
            Vertex::new(29, 2, vec![-1, 63]),
            Vertex::new(30, 1, vec![64, -1]),
            Vertex::new(31, 1, vec![-1, 61, 64]),
            Vertex::new(31, 3, vec![103, 109, 67, 61, -1, 77, 76]),
            Vertex::new(34, 3, vec![80, 66, 77, -1, 71, 68]),
            Vertex::new(34, 2, vec![-1, 71]),
            Vertex::new(35, 1, vec![70, -1]),
            Vertex::new(35, 2, vec![70, 69, 68, 71, -1]),
            Vertex::new(47, 3, vec![73, 80, 68, 69, -1, 72, 57]),
            Vertex::new(47, 1, vec![70, -1, 69]),
        ],
        polygons: vec![
            Polygon::new(3, vec![6, 2, 3, 2, 14, 4]),
            Polygon::new(3, vec![26, 2, 25, -1, 15, 14]),
            Polygon::new(3, vec![6, 3, 5, -1, 0, 5]),
            Polygon::new(3, vec![19, 25, 6, 6, 91, 14]),
            Polygon::new(3, vec![3, 2, 0, -1, 0, -1]),
            Polygon::new(3, vec![5, 3, 4, -1, 2, -1]),
            Polygon::new(3, vec![19, 6, 7, 37, 3, -1]),
            Polygon::new(3, vec![12, 11, 7, 12, 10, 92]),
            Polygon::new(3, vec![56, 24, 23, 115, 17, -1]),
            Polygon::new(3, vec![12, 9, 10, 10, -1, -1]),
            Polygon::new(3, vec![12, 10, 11, 7, 9, -1]),
            Polygon::new(3, vec![16, 11, 13, 100, 101, -1]),
            Polygon::new(3, vec![12, 7, 8, -1, 7, -1]),
            Polygon::new(3, vec![22, 92, 91, 93, 42, -1]),
            Polygon::new(3, vec![25, 2, 6, 3, 1, 0]),
            Polygon::new(3, vec![26, 1, 2, 1, -1, -1]),
            Polygon::new(3, vec![29, 28, 27, 98, -1, -1]),
            Polygon::new(3, vec![56, 52, 24, 8, 97, 24]),
            Polygon::new(3, vec![42, 32, 31, -1, 27, -1]),
            Polygon::new(3, vec![40, 34, 39, 23, -1, 21]),
            Polygon::new(3, vec![99, 98, 13, 62, -1, 100]),
            Polygon::new(3, vec![39, 34, 33, -1, 19, -1]),
            Polygon::new(3, vec![38, 37, 36, -1, -1, 50]),
            Polygon::new(3, vec![40, 39, 41, 111, 19, -1]),
            Polygon::new(3, vec![24, 52, 29, 98, 17, 40]),
            Polygon::new(3, vec![47, 42, 45, 29, 30, 26]),
            Polygon::new(3, vec![45, 42, 43, 28, 25, -1]),
            Polygon::new(3, vec![42, 41, 32, 18, 112, -1]),
            Polygon::new(3, vec![45, 43, 44, -1, 26, -1]),
            Polygon::new(3, vec![47, 45, 46, -1, 25, -1]),
            Polygon::new(3, vec![57, 42, 47, 31, 112, 25]),
            Polygon::new(3, vec![57, 47, 56, -1, 30, 110]),
            Polygon::new(3, vec![50, 48, 51, -1, 33, -1]),
            Polygon::new(3, vec![50, 49, 48, 32, 34, -1]),
            Polygon::new(3, vec![56, 49, 50, 97, 110, 33]),
            Polygon::new(3, vec![66, 65, 64, -1, 88, -1]),
            Polygon::new(3, vec![77, 36, 76, -1, 52, 50]),
            Polygon::new(3, vec![18, 19, 7, 95, 106, 6]),
            Polygon::new(3, vec![55, 54, 30, 39, -1, -1]),
            Polygon::new(3, vec![55, 30, 29, 40, 38, -1]),
            Polygon::new(3, vec![55, 29, 52, 41, 39, 24]),
            Polygon::new(3, vec![55, 52, 53, -1, 40, -1]),
            Polygon::new(3, vec![22, 21, 92, 13, -1, 107]),
            Polygon::new(3, vec![71, 69, 70, 44, 60, 54]),
            Polygon::new(3, vec![81, 71, 70, -1, 55, 43]),
            Polygon::new(3, vec![65, 73, 63, -1, 83, 84]),
            Polygon::new(3, vec![75, 73, 72, 48, 49, 83]),
            Polygon::new(3, vec![58, 40, 57, -1, 75, 111]),
            Polygon::new(3, vec![79, 75, 72, -1, 53, 46]),
            Polygon::new(3, vec![75, 74, 73, 46, -1, -1]),
            Polygon::new(3, vec![76, 36, 37, 82, 36, 22]),
            Polygon::new(3, vec![62, 91, 90, 85, 96, -1]),
            Polygon::new(3, vec![77, 35, 36, 36, -1, -1]),
            Polygon::new(3, vec![79, 78, 75, 48, -1, -1]),
            Polygon::new(3, vec![83, 70, 69, -1, 56, 43]),
            Polygon::new(3, vec![81, 80, 71, 44, -1, -1]),
            Polygon::new(3, vec![83, 82, 70, 54, -1, -1]),
            Polygon::new(3, vec![110, 86, 89, 73, 72, -1]),
            Polygon::new(3, vec![88, 87, 84, 59, -1, -1]),
            Polygon::new(3, vec![88, 84, 68, 74, 58, -1]),
            Polygon::new(3, vec![65, 69, 71, 86, 88, 43]),
            Polygon::new(3, vec![105, 101, 104, -1, 67, 64]),
            Polygon::new(3, vec![99, 13, 14, -1, 20, -1]),
            Polygon::new(3, vec![101, 100, 102, -1, 67, -1]),
            Polygon::new(3, vec![104, 101, 103, -1, 61, -1]),
            Polygon::new(3, vec![94, 90, 93, -1, 79, -1]),
            Polygon::new(3, vec![95, 92, 106, 80, -1, 77]),
            Polygon::new(3, vec![105, 100, 101, 61, 109, 63]),
            Polygon::new(3, vec![110, 106, 109, 69, 80, 71]),
            Polygon::new(3, vec![111, 110, 109, 70, -1, 68]),
            Polygon::new(3, vec![111, 109, 108, -1, 69, -1]),
            Polygon::new(3, vec![109, 106, 107, -1, 68, -1]),
            Polygon::new(3, vec![110, 85, 86, 57, -1, -1]),
            Polygon::new(3, vec![95, 110, 89, 81, 80, 57]),
            Polygon::new(3, vec![67, 88, 68, 90, 89, 59]),
            Polygon::new(3, vec![58, 37, 40, 47, 114, -1]),
            Polygon::new(3, vec![96, 105, 92, 107, 103, 77]),
            Polygon::new(3, vec![92, 105, 106, 66, 76, -1]),
            Polygon::new(3, vec![94, 89, 88, 79, 81, -1]),
            Polygon::new(3, vec![94, 88, 90, 65, 78, 89]),
            Polygon::new(3, vec![95, 106, 110, 73, 66, 68]),
            Polygon::new(3, vec![95, 89, 94, -1, 73, 78]),
            Polygon::new(3, vec![61, 76, 37, 114, 119, 50]),
            Polygon::new(3, vec![65, 72, 73, 45, 86, 46]),
            Polygon::new(3, vec![63, 73, 76, 119, 45, -1]),
            Polygon::new(3, vec![67, 62, 90, 89, -1, 51]),
            Polygon::new(3, vec![65, 71, 72, 83, 60, -1]),
            Polygon::new(3, vec![66, 68, 69, 88, 90, -1]),
            Polygon::new(3, vec![66, 69, 65, 35, 87, 60]),
            Polygon::new(3, vec![67, 90, 88, 74, 85, 79]),
            Polygon::new(3, vec![67, 68, 66, -1, 74, 87]),
            Polygon::new(3, vec![19, 27, 25, 3, 99, -1]),
            Polygon::new(3, vec![15, 7, 11, 101, 95, 7]),
            Polygon::new(3, vec![23, 22, 91, 117, 94, 13]),
            Polygon::new(3, vec![23, 20, 22, 93, -1, -1]),
            Polygon::new(3, vec![18, 7, 15, -1, 37, 92]),
            Polygon::new(3, vec![60, 91, 62, 116, 117, 51]),
            Polygon::new(3, vec![56, 50, 52, 17, 34, -1]),
            Polygon::new(3, vec![24, 29, 27, 99, 24, 16]),
            Polygon::new(3, vec![24, 27, 19, -1, 98, 91]),
            Polygon::new(3, vec![16, 13, 98, 108, 11, 20]),
            Polygon::new(3, vec![16, 15, 11, 11, 104, 92]),
            Polygon::new(3, vec![97, 98, 100, 109, 108, -1]),
            Polygon::new(3, vec![97, 105, 96, -1, 109, 76]),
            Polygon::new(3, vec![17, 15, 16, -1, -1, 101]),
            Polygon::new(3, vec![96, 21, 18, -1, 107, 106]),
            Polygon::new(3, vec![18, 21, 19, 37, 105, -1]),
            Polygon::new(3, vec![96, 92, 21, 105, 76, 42]),
            Polygon::new(3, vec![97, 16, 98, 102, -1, 100]),
            Polygon::new(3, vec![97, 100, 105, 103, 102, 67]),
            Polygon::new(3, vec![56, 47, 49, 34, 31, -1]),
            Polygon::new(3, vec![57, 40, 41, 112, 47, 23]),
            Polygon::new(3, vec![57, 41, 42, 30, 111, 27]),
            Polygon::new(3, vec![61, 58, 59, -1, 114, -1]),
            Polygon::new(3, vec![61, 37, 58, 113, 82, 75]),
            Polygon::new(3, vec![60, 56, 23, 117, -1, 8]),
            Polygon::new(3, vec![61, 60, 62, 118, -1, 96]),
            Polygon::new(3, vec![60, 23, 91, 96, 115, 93]),
