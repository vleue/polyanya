...
fn arena_mesh() -> Mesh {
    Mesh::new(
        ...
        vec![
            Polygon::using(3, vec![6, 2, 3, 2, 5, 1]),
            Polygon::using(3, vec![3, 2, 0, -1, 0, -1]),
            Polygon::using(4, vec![5, 6, 3, 4, -1, -1, 0, -1]),
            Polygon::using(4, vec![10, 11, 12, 9, -1, -1, 16, -1]),
            Polygon::using(3, vec![12, 7, 8, -1, 16, -1]),
            Polygon::using(
                8,
                vec![7, 15, 18, 21, 19, 25, 2, 6, -1, 16, -1, 54, -1, 51, 6, 0],
            ),
            Polygon::using(4, vec![2, 25, 26, 1, -1, 5, -1, -1]),
            Polygon::using(3, vec![29, 28, 27, 46, -1, -1]),
            Polygon::using(4, vec![42, 41, 32, 31, -1, 45, -1, -1]),
            Polygon::using(4, vec![39, 40, 34, 33, -1, 45, -1, -1]),
            Polygon::using(3, vec![38, 37, 36, -1, -1, 21]),
            Polygon::using(4, vec![45, 42, 43, 44, -1, 45, -1, -1]),
            Polygon::using(3, vec![47, 45, 46, -1, 45, -1]),
            Polygon::using(6, vec![50, 52, 56, 57, 47, 49, 14, -1, 46, -1, 45, -1]),
            Polygon::using(4, vec![50, 49, 48, 51, -1, 13, -1, -1]),
            Polygon::using(3, vec![66, 65, 64, -1, 49, -1]),
            Polygon::using(7, vec![7, 12, 11, 13, 98, 16, 15, 5, 4, 3, -1, 28, 41, 39]),
            Polygon::using(4, vec![30, 29, 55, 54, -1, -1, 46, -1]),
            Polygon::using(3, vec![55, 52, 53, -1, 46, -1]),
            Polygon::using(
                8,
                vec![
            ...
            Polygon::using(3, vec![75, 74, 73, 19, -1, -1]),
            Polygon::using(3, vec![76, 36, 37, 47, 22, 10]),
            Polygon::using(4, vec![36, 76, 77, 35, -1, 21, -1, -1]),
            Polygon::using(4, vec![75, 72, 79, 78, -1, 19, -1, -1]),
            Polygon::using(4, vec![71, 70, 81, 80, -1, 19, -1, -1]),
            Polygon::using(4, vec![70, 69, 83, 82, -1, 19, -1, -1]),
            Polygon::using(4, vec![84, 68, 88, 87, -1, -1, 31, -1]),
            Polygon::using(4, vec![58, 37, 40, 57, -1, 42, -1, 45]),
            Polygon::using(4, vec![99, 98, 13, 14, -1, -1, 16, -1]),
            Polygon::using(3, vec![101, 100, 102, -1, 32, -1]),
            Polygon::using(4, vec![104, 105, 101, 103, -1, -1, 32, -1]),
            Polygon::using(
                7,
                vec![62, 60, 91, 90, 88, 68, 67, -1, 47, 54, -1, 43, 26, 50],
            ),
            Polygon::using(3, vec![105, 100, 101, 30, 37, 29]),
            Polygon::using(3, vec![110, 106, 109, 34, 37, 35]),
            Polygon::using(4, vec![111, 110, 109, 108, -1, -1, 33, -1]),
            Polygon::using(3, vec![109, 106, 107, -1, 33, -1]),
            Polygon::using(4, vec![86, 89, 110, 85, -1, -1, 37, -1]),
            Polygon::using(
                10,
                vec![
            ...
            Polygon::using(4, vec![23, 60, 56, 24, -1, 52, -1, 46]),
            Polygon::using(3, vec![17, 15, 16, -1, -1, 16]),
            Polygon::using(3, vec![94, 90, 93, -1, 43, -1]),
            Polygon::using(3, vec![97, 16, 98, 37, -1, 16]),
            Polygon::using(3, vec![61, 37, 58, 48, 47, 27]),
            Polygon::using(3, vec![94, 88, 90, 40, 44, 31]),
            Polygon::using(4, vec![89, 88, 94, 95, 37, -1, 43, -1]),
            Polygon::using(
                7,
            ...
            Polygon::using(3, vec![61, 58, 59, -1, 42, -1]),
            Polygon::using(3, vec![66, 69, 65, 15, 50, 19]),
            Polygon::using(4, vec![68, 69, 66, 67, 31, -1, 49, -1]),
            Polygon::using(3, vec![19, 27, 25, 5, 46, -1]),
            Polygon::using(3, vec![23, 22, 60, 38, 53, 54]),
            Polygon::using(3, vec![23, 20, 22, 52, -1, -1]),
            Polygon::using(
                7,
