...
/// [crate::vendored_spade::HierarchyHintGenerator] may be beneficial.
///
/// If subsequent queries are close to each other, [crate::vendored_spade::LastUsedVertexHintGenerator] should also work fine.
...
///
/// Created by calling [crate::vendored_spade::FloatTriangulation::barycentric].
///
